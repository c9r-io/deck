...
- Install a Deck release that includes Secure Tunnel integration. **Download Deck and Deck Tunnel Helper from the same [Deck release](https://github.com/c9r-io/deck/releases).** Secure Tunnel support is currently in the Nightly channel; the [latest Stable download](https://github.com/c9r-io/deck/releases/latest) may not yet include it.
