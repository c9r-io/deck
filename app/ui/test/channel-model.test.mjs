...
import { channelDigestId, channelRunExpired, channelSource, channelTemplatePlan, collectingCard, nextCollectedAt, normalizeChannelConfig, unfinishedChannelPlans } from '../js/channel-model.js';
...
test('template plan freezes expanded text and source retains reference ids without inventing links', () => {
  const item = { body: 'INC-4 failed', channelId: 'C1', eventId: 'Ev1', connectionId: 'default', workspaceId: 'T1',
    ruleId: 'R1', occurredAt: 123, messageTs: '123.4', senderUserId: 'U1', target: { template: 'triage' } };
