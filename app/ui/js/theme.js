...
export const REQUIRED_CSS_TOKENS = Object.freeze([
  ...
  'attn', 'attn-border', 'attn-border-hover', 'done',
...
const BASE_PALETTES = {
  'deck-dark': {
    ...
    css: {
      ...
      attn: '#c678dd', 'attn-border': 'rgba(198, 120, 221, 0.50)',
      'attn-border-hover': 'rgba(198, 120, 221, 0.80)', done: '#6ca8ff',
  ...
  light: {
    ...
    css: {
      ...
      attn: '#6938ef', 'attn-border': 'rgba(105, 56, 239, 0.48)',
      'attn-border-hover': 'rgba(105, 56, 239, 0.76)', done: '#175cd3',
  ...
  'high-contrast': {
    ...
    css: {
      ...
      attn: '#e0aaff', 'attn-border': '#e0aaff',
      'attn-border-hover': '#ffffff', done: '#80bfff',
