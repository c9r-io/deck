...
const SMOKE_CHECKS: &[&str] = &[
    ...
    "multiline-prompt",
    "voice-layout-bottom",
    "voice-layout-floating",
    "voice-layout-right",
    "voice-ime",
    "voice-binding-refusal",
    "voice-binding-current-program",
    "voice-actions-empty",
    "voice-actions-empty-noop",
    "voice-actions-recording",
    "voice-actions-clear",
    "voice-session-new",
    "voice-session-restore",
    "voice-session-delivery",
    "voice-insert",
    "voice-insert-visible",
    "voice-submit",
    "voice-target-ended",
    "voice-leave",
    "voice-theme-light",
