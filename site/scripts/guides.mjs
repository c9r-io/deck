...
<p class="guide-source">${zh ? '内容基于 deck 0.6.5。技术细节：' : 'Based on deck 0.6.5. Technical reference: '}<a href="${config.githubUrl}/blob/${config.guideRef}/README.md">README ↗</a> · <a href="${config.feedbackUrl}">${zh ? '反馈问题' : 'Report an issue'}</a></p></main>
